...
public class Utils {
	...
	public static String milesToKm(String radius)
	{
		
		Double radiusKm = Double.parseDouble(radius)*1.60934;
		String radiusKmStr = radiusKm.toString();
		return radiusKmStr;
		
	}
	
	public static String kmTomiles(String radius)
	{
		
		Double radiusMiles = Double.parseDouble(radius)*0.621371;
		String radiusMilesStr = radiusMiles.toString();
		return radiusMilesStr ;
