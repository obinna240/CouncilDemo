...
public class CacheHandler {
	...
	public static void initCaches() throws CacheException {
    	...
    	cm.addCache(new Cache(CacheName.CMSCONTENT.toString(), 500, false, false, 60, 60));//500 item, 60 secs expiry
    	cm.addCache(new Cache(CacheName.CATEGORIES.toString(), 10000, false, true, 0, 0));//200 items, eternal
      	cm.addCache(new Cache(CacheName.TREENODES.toString(), 10000, false, true, 0, 0));//200 items, eternal
